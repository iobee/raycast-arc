...
import { getDomain, getLastVisitedAt, getDownloadedAt, getSpaceTitle, getLocationTitle } from "./utils";
...
export function TabListItem(props: { tab: Tab; searchText: string; mutate: MutatePromise<Tab[] | undefined> }) {
  return (
    <List.Item
      ...
      accessories={[
        { text: props.tab.space ? props.tab.space.title : getLocationTitle(props.tab.location)}
      ]}
